...
public class EntrantRegistrationActivityTest {
    ...
    @Test
    public void testSuccessfulRegistrationNavigatesToMainScreen() {
        ...
        // Should navigate to EntrantMainActivity
        intended(hasComponent(EntrantMainActivity.class.getName()));
    }
}
