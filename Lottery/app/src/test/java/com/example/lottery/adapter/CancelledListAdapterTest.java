...
public class CancelledListAdapterTest {
    ...
    public void setUp() {
        ...
        e.setUserName("Marcus Rivera");
        entrantList.add(e);

        adapter = new CancelledListAdapter(context, entrantList);
    }

    // US 02.06.02: Verify adapter returns correct item count for cancelled entrants list
    /**
    ...
    // US 02.06.02: Verify cancelled list adapter is correctly instantiated
    /**
